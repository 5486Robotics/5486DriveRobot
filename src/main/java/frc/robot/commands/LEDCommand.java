...
public class LEDCommand extends CommandBase {
   ...
   */
  public LEDCommand(LEDSubsystem subsystem, CommandPS4Controller joystick) {
  ...
  @Override
  public void execute() {
   if(controller.share().getAsBoolean()){
    ledSubsystem.setLEDPurple();
   }else if(controller.PS().getAsBoolean()){
    ledSubsystem.setLEDYellow();
   }else if(controller.touchpad().getAsBoolean()){
    ledSubsystem.blinkLEDRed();
   }
  }
